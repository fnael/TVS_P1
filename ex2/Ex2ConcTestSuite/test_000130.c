...
int main(void)
{
    ...
    /* add key=167772161 */
    int *k45 = malloc(sizeof(int)); *k45 = 167772161;
    ...
    /* get_greater_than key=1090584577 */
    search_key = 1090584577;
    if (treetable_get_greater_than(table, &search_key, &out) == CC_OK)
        assert(out != NULL);
    ...
    /* add key=16973824 */
    int *k65 = malloc(sizeof(int)); *k65 = 16973824;
    alloc_keys[alloc_count++] = k65;
    treetable_add(table, k65, k65);
    assert(balanced(table) && sorted(table));

    /* add key=2561 */
    int *k70 = malloc(sizeof(int)); *k70 = 2561;
    ...
    /* get_greater_than key=16973824 */
    search_key = 16973824;
    if (treetable_get_greater_than(table, &search_key, &out) == CC_OK)
        assert(out != NULL);

    /* add key=167772161 */
    int *k90 = malloc(sizeof(int)); *k90 = 167772161;
