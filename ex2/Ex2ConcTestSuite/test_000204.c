...
int main(void)
{
    ...
    /* add key=-58768640 */
    int *k85 = malloc(sizeof(int)); *k85 = -58768640;
    ...
    /* add key=-1644104695 */
    int *k145 = malloc(sizeof(int)); *k145 = -1644104695;
    alloc_keys[alloc_count++] = k145;
    treetable_add(table, k145, k145);
    assert(balanced(table) && sorted(table));

    /* add key=7168 */
    int *k150 = malloc(sizeof(int)); *k150 = 7168;
