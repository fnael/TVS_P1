...
int main(void)
{
    ...
    /* add key=138494273 */
    int *k20 = malloc(sizeof(int)); *k20 = 138494273;
    ...
    /* add key=1094713600 */
    int *k45 = malloc(sizeof(int)); *k45 = 1094713600;
    ...
    /* add key=4784128 */
    int *k245 = malloc(sizeof(int)); *k245 = 4784128;
    ...
    /* add key=253 */
    int *k285 = malloc(sizeof(int)); *k285 = 253;
    alloc_keys[alloc_count++] = k285;
    treetable_add(table, k285, k285);
    assert(balanced(table) && sorted(table));

    /* add key=-77314972 */
    int *k290 = malloc(sizeof(int)); *k290 = -77314972;
    ...
    /* add key=1224736768 */
    int *k340 = malloc(sizeof(int)); *k340 = 1224736768;
    alloc_keys[alloc_count++] = k340;
    treetable_add(table, k340, k340);
    assert(balanced(table) && sorted(table));

    /* add key=1325400192 */
    int *k345 = malloc(sizeof(int)); *k345 = 1325400192;
    ...
    /* add key=2688 */
    int *k355 = malloc(sizeof(int)); *k355 = 2688;
    alloc_keys[alloc_count++] = k355;
    treetable_add(table, k355, k355);
    assert(balanced(table) && sorted(table));

    /* add key=589892 */
    int *k360 = malloc(sizeof(int)); *k360 = 589892;
    ...
    /* add key=-2147464960 */
    int *k370 = malloc(sizeof(int)); *k370 = -2147464960;
    alloc_keys[alloc_count++] = k370;
    treetable_add(table, k370, k370);
    assert(balanced(table) && sorted(table));

    /* add key=1094795585 */
    int *k375 = malloc(sizeof(int)); *k375 = 1094795585;
    alloc_keys[alloc_count++] = k375;
    treetable_add(table, k375, k375);
    assert(balanced(table) && sorted(table));
