...
int main(void)
{
    ...
    /* get_greater_than key=167772161 */
    search_key = 167772161;
    if (treetable_get_greater_than(table, &search_key, &out) == CC_OK)
        assert(out != NULL);

    /* add key=167837696 */
    int *k65 = malloc(sizeof(int)); *k65 = 167837696;
    ...
    /* add key=11 */
    int *k95 = malloc(sizeof(int)); *k95 = 11;
    ...
    /* add key=2816 */
    int *k110 = malloc(sizeof(int)); *k110 = 2816;
