; ModuleID = 'treetable_add_linked.bc'
...
@.str.2 = private unnamed_addr constant [3 x i8] c"v1\00", align 1, !dbg !9
@.str.3 = private unnamed_addr constant [3 x i8] c"v2\00", align 1, !dbg !11
@.str.4 = private unnamed_addr constant [10 x i8] c"sorted(t)\00", align 1, !dbg !13
@.str.5 = private unnamed_addr constant [38 x i8] c"Ex3SymbTestSuite/treetable_add_symb.c\00", align 1, !dbg !18
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [15 x i8] c"int main(void)\00", align 1, !dbg !23
@.str.6 = private unnamed_addr constant [12 x i8] c"balanced(t)\00", align 1, !dbg !29
@.str.7 = private unnamed_addr constant [23 x i8] c"treetable_size(t) == 1\00", align 1, !dbg !34
@.str.8 = private unnamed_addr constant [37 x i8] c"treetable_get(t, &k1, &out) == CC_OK\00", align 1, !dbg !39
@.str.9 = private unnamed_addr constant [17 x i8] c"*(int*)out == v1\00", align 1, !dbg !44
@.str.10 = private unnamed_addr constant [37 x i8] c"treetable_get(t, &k2, &out) == CC_OK\00", align 1, !dbg !49
@.str.11 = private unnamed_addr constant [17 x i8] c"*(int*)out == v2\00", align 1, !dbg !51
@.str.12 = private unnamed_addr constant [28 x i8] c"treetable_size(t) == before\00", align 1, !dbg !53
@.str.13 = private unnamed_addr constant [32 x i8] c"treetable_size(t) == before + 1\00", align 1, !dbg !58
...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %v1, metadata !1131, metadata !DIExpression()), !dbg !1132
  call void @llvm.dbg.declare(metadata ptr %v2, metadata !1133, metadata !DIExpression()), !dbg !1134
  call void @klee_make_symbolic(ptr noundef %k1, i64 noundef 4, ptr noundef @.str), !dbg !1135
  call void @klee_make_symbolic(ptr noundef %k2, i64 noundef 4, ptr noundef @.str.1), !dbg !1136
  call void @klee_make_symbolic(ptr noundef %v1, i64 noundef 4, ptr noundef @.str.2), !dbg !1137
  call void @klee_make_symbolic(ptr noundef %v2, i64 noundef 4, ptr noundef @.str.3), !dbg !1138
  call void @llvm.dbg.declare(metadata ptr %t, metadata !1139, metadata !DIExpression()), !dbg !1144
  %call = call i32 @treetable_new(ptr noundef %t), !dbg !1145
  %0 = load ptr, ptr %t, align 8, !dbg !1146
  %call1 = call i32 @treetable_add(ptr noundef %0, ptr noundef %k1, ptr noundef %v1), !dbg !1147
  %1 = load ptr, ptr %t, align 8, !dbg !1148
  %call2 = call i32 @sorted(ptr noundef %1), !dbg !1148
  %tobool = icmp ne i32 %call2, 0, !dbg !1148
  br i1 %tobool, label %if.end, label %if.else, !dbg !1151

if.else:                                          ; preds = %entry
  call void @__assert_fail(ptr noundef @.str.4, ptr noundef @.str.5, i32 noundef 48, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1148
  unreachable, !dbg !1148

if.end:                                           ; preds = %entry
  %2 = load ptr, ptr %t, align 8, !dbg !1152
  %call3 = call i32 @balanced(ptr noundef %2), !dbg !1152
  %tobool4 = icmp ne i32 %call3, 0, !dbg !1152
  br i1 %tobool4, label %if.end7, label %if.else6, !dbg !1155

if.else6:                                         ; preds = %if.end
  call void @__assert_fail(ptr noundef @.str.6, ptr noundef @.str.5, i32 noundef 49, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1152
  unreachable, !dbg !1152

if.end7:                                          ; preds = %if.end
  %3 = load ptr, ptr %t, align 8, !dbg !1156
  %call8 = call i64 @treetable_size(ptr noundef %3), !dbg !1156
  %cmp = icmp eq i64 %call8, 1, !dbg !1156
  br i1 %cmp, label %if.end11, label %if.else10, !dbg !1159

if.else10:                                        ; preds = %if.end7
  call void @__assert_fail(ptr noundef @.str.7, ptr noundef @.str.5, i32 noundef 51, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1156
  unreachable, !dbg !1156

if.end11:                                         ; preds = %if.end7
  call void @llvm.dbg.declare(metadata ptr %out, metadata !1160, metadata !DIExpression()), !dbg !1161
  %4 = load ptr, ptr %t, align 8, !dbg !1162
  %call12 = call i32 @treetable_get(ptr noundef %4, ptr noundef %k1, ptr noundef %out), !dbg !1162
  %cmp13 = icmp eq i32 %call12, 0, !dbg !1162
  br i1 %cmp13, label %if.end16, label %if.else15, !dbg !1165

if.else15:                                        ; preds = %if.end11
  call void @__assert_fail(ptr noundef @.str.8, ptr noundef @.str.5, i32 noundef 55, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1162
  unreachable, !dbg !1162

if.end16:                                         ; preds = %if.end11
  %5 = load ptr, ptr %out, align 8, !dbg !1166
  %6 = load i32, ptr %5, align 4, !dbg !1166
  %7 = load i32, ptr %v1, align 4, !dbg !1166
  %cmp17 = icmp eq i32 %6, %7, !dbg !1166
  br i1 %cmp17, label %if.end20, label %if.else19, !dbg !1169

if.else19:                                        ; preds = %if.end16
  call void @__assert_fail(ptr noundef @.str.9, ptr noundef @.str.5, i32 noundef 56, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1166
  unreachable, !dbg !1166

if.end20:                                         ; preds = %if.end16
  call void @llvm.dbg.declare(metadata ptr %before, metadata !1170, metadata !DIExpression()), !dbg !1171
  %8 = load ptr, ptr %t, align 8, !dbg !1172
  %call21 = call i64 @treetable_size(ptr noundef %8), !dbg !1173
  store i64 %call21, ptr %before, align 8, !dbg !1171
  %9 = load ptr, ptr %t, align 8, !dbg !1174
  %call22 = call i32 @treetable_add(ptr noundef %9, ptr noundef %k2, ptr noundef %v2), !dbg !1175
  %10 = load ptr, ptr %t, align 8, !dbg !1176
  %call23 = call i32 @sorted(ptr noundef %10), !dbg !1176
  %tobool24 = icmp ne i32 %call23, 0, !dbg !1176
  br i1 %tobool24, label %if.end27, label %if.else26, !dbg !1179

if.else26:                                        ; preds = %if.end20
  call void @__assert_fail(ptr noundef @.str.4, ptr noundef @.str.5, i32 noundef 65, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1176
  unreachable, !dbg !1176

if.end27:                                         ; preds = %if.end20
  %11 = load ptr, ptr %t, align 8, !dbg !1180
  %call28 = call i32 @balanced(ptr noundef %11), !dbg !1180
  %tobool29 = icmp ne i32 %call28, 0, !dbg !1180
  br i1 %tobool29, label %if.end32, label %if.else31, !dbg !1183

if.else31:                                        ; preds = %if.end27
  call void @__assert_fail(ptr noundef @.str.6, ptr noundef @.str.5, i32 noundef 66, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1180
  unreachable, !dbg !1180

if.end32:                                         ; preds = %if.end27
  %12 = load ptr, ptr %t, align 8, !dbg !1184
  %call33 = call i32 @treetable_get(ptr noundef %12, ptr noundef %k2, ptr noundef %out), !dbg !1184
  %cmp34 = icmp eq i32 %call33, 0, !dbg !1184
  br i1 %cmp34, label %if.end37, label %if.else36, !dbg !1187

if.else36:                                        ; preds = %if.end32
  call void @__assert_fail(ptr noundef @.str.10, ptr noundef @.str.5, i32 noundef 68, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1184
  unreachable, !dbg !1184

if.end37:                                         ; preds = %if.end32
  %13 = load ptr, ptr %out, align 8, !dbg !1188
  %14 = load i32, ptr %13, align 4, !dbg !1188
  %15 = load i32, ptr %v2, align 4, !dbg !1188
  %cmp38 = icmp eq i32 %14, %15, !dbg !1188
  br i1 %cmp38, label %if.end41, label %if.else40, !dbg !1191

if.else40:                                        ; preds = %if.end37
  call void @__assert_fail(ptr noundef @.str.11, ptr noundef @.str.5, i32 noundef 69, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1188
  unreachable, !dbg !1188

if.end41:                                         ; preds = %if.end37
  %16 = load i32, ptr %k1, align 4, !dbg !1192
  %17 = load i32, ptr %k2, align 4, !dbg !1194
  %cmp42 = icmp eq i32 %16, %17, !dbg !1195
  br i1 %cmp42, label %if.then43, label %if.else49, !dbg !1196

if.then43:                                        ; preds = %if.end41
  %18 = load ptr, ptr %t, align 8, !dbg !1197
  %call44 = call i64 @treetable_size(ptr noundef %18), !dbg !1197
  %19 = load i64, ptr %before, align 8, !dbg !1197
  %cmp45 = icmp eq i64 %call44, %19, !dbg !1197
  br i1 %cmp45, label %if.end55, label %if.else47, !dbg !1200

if.else47:                                        ; preds = %if.then43
  call void @__assert_fail(ptr noundef @.str.12, ptr noundef @.str.5, i32 noundef 81, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1197
  unreachable, !dbg !1197

if.else49:                                        ; preds = %if.end41
  %20 = load ptr, ptr %t, align 8, !dbg !1201
  %call50 = call i64 @treetable_size(ptr noundef %20), !dbg !1201
  %21 = load i64, ptr %before, align 8, !dbg !1201
  %add = add i64 %21, 1, !dbg !1201
  %cmp51 = icmp eq i64 %call50, %add, !dbg !1201
  br i1 %cmp51, label %if.end55, label %if.else53, !dbg !1204

if.else53:                                        ; preds = %if.else49
  call void @__assert_fail(ptr noundef @.str.13, ptr noundef @.str.5, i32 noundef 83, ptr noundef @__PRETTY_FUNCTION__.main) #7, !dbg !1201
  unreachable, !dbg !1201

if.end55:                                         ; preds = %if.else49, %if.then43
  %22 = load ptr, ptr %t, align 8, !dbg !1205
  call void @treetable_destroy(ptr noundef %22), !dbg !1206
  ret i32 0, !dbg !1207
}
...
!2 = !DIFile(filename: "Ex3SymbTestSuite/treetable_add_symb.c", directory: "/home/klee/work/ex3", checksumkind: CSK_MD5, checksum: "e0097fb35746ce4bcb31b09f84318366")
!3 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 24, elements: !5)
!4 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!5 = !{!6}
!6 = !DISubrange(count: 3)
!7 = !DIGlobalVariableExpression(var: !8, expr: !DIExpression())
!8 = distinct !DIGlobalVariable(scope: null, file: !2, line: 34, type: !3, isLocal: true, isDefinition: true)
!9 = !DIGlobalVariableExpression(var: !10, expr: !DIExpression())
!10 = distinct !DIGlobalVariable(scope: null, file: !2, line: 36, type: !3, isLocal: true, isDefinition: true)
!11 = !DIGlobalVariableExpression(var: !12, expr: !DIExpression())
!12 = distinct !DIGlobalVariable(scope: null, file: !2, line: 37, type: !3, isLocal: true, isDefinition: true)
!13 = !DIGlobalVariableExpression(var: !14, expr: !DIExpression())
!14 = distinct !DIGlobalVariable(scope: null, file: !2, line: 48, type: !15, isLocal: true, isDefinition: true)
...
!25 = !DICompositeType(tag: DW_TAG_array_type, baseType: !26, size: 120, elements: !27)
...
!35 = distinct !DIGlobalVariable(scope: null, file: !2, line: 51, type: !36, isLocal: true, isDefinition: true)
!36 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 184, elements: !37)
!37 = !{!38}
!38 = !DISubrange(count: 23)
!39 = !DIGlobalVariableExpression(var: !40, expr: !DIExpression())
!40 = distinct !DIGlobalVariable(scope: null, file: !2, line: 55, type: !41, isLocal: true, isDefinition: true)
!41 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 296, elements: !42)
!42 = !{!43}
!43 = !DISubrange(count: 37)
!44 = !DIGlobalVariableExpression(var: !45, expr: !DIExpression())
!45 = distinct !DIGlobalVariable(scope: null, file: !2, line: 56, type: !46, isLocal: true, isDefinition: true)
!46 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 136, elements: !47)
!47 = !{!48}
!48 = !DISubrange(count: 17)
!49 = !DIGlobalVariableExpression(var: !50, expr: !DIExpression())
!50 = distinct !DIGlobalVariable(scope: null, file: !2, line: 68, type: !41, isLocal: true, isDefinition: true)
!51 = !DIGlobalVariableExpression(var: !52, expr: !DIExpression())
!52 = distinct !DIGlobalVariable(scope: null, file: !2, line: 69, type: !46, isLocal: true, isDefinition: true)
!53 = !DIGlobalVariableExpression(var: !54, expr: !DIExpression())
!54 = distinct !DIGlobalVariable(scope: null, file: !2, line: 81, type: !55, isLocal: true, isDefinition: true)
!55 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 224, elements: !56)
!56 = !{!57}
!57 = !DISubrange(count: 28)
!58 = !DIGlobalVariableExpression(var: !59, expr: !DIExpression())
!59 = distinct !DIGlobalVariable(scope: null, file: !2, line: 83, type: !60, isLocal: true, isDefinition: true)
!60 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 256, elements: !61)
!61 = !{!62}
...
!84 = !{!80}
!85 = !{!0, !7, !9, !11, !13, !18, !23, !29, !34, !39, !44, !49, !51, !53, !58}
...
!1124 = distinct !DISubprogram(name: "main", scope: !2, file: !2, line: 25, type: !1125, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !83, retainedNodes: !99)
!1125 = !DISubroutineType(types: !1126)
!1126 = !{!81}
!1127 = !DILocalVariable(name: "k1", scope: !1124, file: !2, line: 27, type: !81)
!1128 = !DILocation(line: 27, column: 9, scope: !1124)
!1129 = !DILocalVariable(name: "k2", scope: !1124, file: !2, line: 27, type: !81)
!1130 = !DILocation(line: 27, column: 13, scope: !1124)
!1131 = !DILocalVariable(name: "v1", scope: !1124, file: !2, line: 28, type: !81)
!1132 = !DILocation(line: 28, column: 9, scope: !1124)
!1133 = !DILocalVariable(name: "v2", scope: !1124, file: !2, line: 28, type: !81)
!1134 = !DILocation(line: 28, column: 13, scope: !1124)
!1135 = !DILocation(line: 33, column: 5, scope: !1124)
!1136 = !DILocation(line: 34, column: 5, scope: !1124)
!1137 = !DILocation(line: 36, column: 5, scope: !1124)
!1138 = !DILocation(line: 37, column: 5, scope: !1124)
!1139 = !DILocalVariable(name: "t", scope: !1124, file: !2, line: 39, type: !1140)
!1140 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1141, size: 64)
!1141 = !DIDerivedType(tag: DW_TAG_typedef, name: "TreeTable", file: !1142, line: 30, baseType: !1143)
!1142 = !DIFile(filename: "Ex3SymbTestSuite/../../ex2/treetable.h", directory: "/home/klee/work/ex3", checksumkind: CSK_MD5, checksum: "065f0d2b52ad730b442c75c554f59b69")
!1143 = !DICompositeType(tag: DW_TAG_structure_type, name: "treetable_s", file: !1142, line: 30, flags: DIFlagFwdDecl)
!1144 = !DILocation(line: 39, column: 16, scope: !1124)
!1145 = !DILocation(line: 41, column: 5, scope: !1124)
!1146 = !DILocation(line: 46, column: 19, scope: !1124)
!1147 = !DILocation(line: 46, column: 5, scope: !1124)
!1148 = !DILocation(line: 48, column: 5, scope: !1149)
!1149 = distinct !DILexicalBlock(scope: !1150, file: !2, line: 48, column: 5)
!1150 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 48, column: 5)
!1151 = !DILocation(line: 48, column: 5, scope: !1150)
!1152 = !DILocation(line: 49, column: 5, scope: !1153)
!1153 = distinct !DILexicalBlock(scope: !1154, file: !2, line: 49, column: 5)
!1154 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 49, column: 5)
!1155 = !DILocation(line: 49, column: 5, scope: !1154)
!1156 = !DILocation(line: 51, column: 5, scope: !1157)
!1157 = distinct !DILexicalBlock(scope: !1158, file: !2, line: 51, column: 5)
!1158 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 51, column: 5)
!1159 = !DILocation(line: 51, column: 5, scope: !1158)
!1160 = !DILocalVariable(name: "out", scope: !1124, file: !2, line: 53, type: !82)
!1161 = !DILocation(line: 53, column: 11, scope: !1124)
!1162 = !DILocation(line: 55, column: 5, scope: !1163)
!1163 = distinct !DILexicalBlock(scope: !1164, file: !2, line: 55, column: 5)
!1164 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 55, column: 5)
!1165 = !DILocation(line: 55, column: 5, scope: !1164)
!1166 = !DILocation(line: 56, column: 5, scope: !1167)
!1167 = distinct !DILexicalBlock(scope: !1168, file: !2, line: 56, column: 5)
!1168 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 56, column: 5)
!1169 = !DILocation(line: 56, column: 5, scope: !1168)
!1170 = !DILocalVariable(name: "before", scope: !1124, file: !2, line: 61, type: !140)
!1171 = !DILocation(line: 61, column: 12, scope: !1124)
!1172 = !DILocation(line: 61, column: 36, scope: !1124)
!1173 = !DILocation(line: 61, column: 21, scope: !1124)
!1174 = !DILocation(line: 63, column: 19, scope: !1124)
!1175 = !DILocation(line: 63, column: 5, scope: !1124)
!1176 = !DILocation(line: 65, column: 5, scope: !1177)
!1177 = distinct !DILexicalBlock(scope: !1178, file: !2, line: 65, column: 5)
!1178 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 65, column: 5)
!1179 = !DILocation(line: 65, column: 5, scope: !1178)
!1180 = !DILocation(line: 66, column: 5, scope: !1181)
!1181 = distinct !DILexicalBlock(scope: !1182, file: !2, line: 66, column: 5)
!1182 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 66, column: 5)
!1183 = !DILocation(line: 66, column: 5, scope: !1182)
!1184 = !DILocation(line: 68, column: 5, scope: !1185)
!1185 = distinct !DILexicalBlock(scope: !1186, file: !2, line: 68, column: 5)
!1186 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 68, column: 5)
!1187 = !DILocation(line: 68, column: 5, scope: !1186)
!1188 = !DILocation(line: 69, column: 5, scope: !1189)
!1189 = distinct !DILexicalBlock(scope: !1190, file: !2, line: 69, column: 5)
!1190 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 69, column: 5)
!1191 = !DILocation(line: 69, column: 5, scope: !1190)
!1192 = !DILocation(line: 80, column: 9, scope: !1193)
!1193 = distinct !DILexicalBlock(scope: !1124, file: !2, line: 80, column: 9)
!1194 = !DILocation(line: 80, column: 15, scope: !1193)
!1195 = !DILocation(line: 80, column: 12, scope: !1193)
!1196 = !DILocation(line: 80, column: 9, scope: !1124)
!1197 = !DILocation(line: 81, column: 9, scope: !1198)
!1198 = distinct !DILexicalBlock(scope: !1199, file: !2, line: 81, column: 9)
!1199 = distinct !DILexicalBlock(scope: !1193, file: !2, line: 81, column: 9)
!1200 = !DILocation(line: 81, column: 9, scope: !1199)
!1201 = !DILocation(line: 83, column: 9, scope: !1202)
!1202 = distinct !DILexicalBlock(scope: !1203, file: !2, line: 83, column: 9)
!1203 = distinct !DILexicalBlock(scope: !1193, file: !2, line: 83, column: 9)
!1204 = !DILocation(line: 83, column: 9, scope: !1203)
!1205 = !DILocation(line: 85, column: 23, scope: !1124)
!1206 = !DILocation(line: 85, column: 5, scope: !1124)
!1207 = !DILocation(line: 87, column: 5, scope: !1124)
